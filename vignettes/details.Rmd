...
```{r}
mybiodb$getPersistentCache()$pathsExist(sub.folder=conn$getCacheId(), paths='17001', suffix=conn$getEntryFileExt())
```
And get the path to the cache file:
```{r}
mybiodb$getPersistentCache()$getPaths(sub.folder=conn$getCacheId(), paths='17001', suffix=conn$getEntryFileExt())
```
